...
import StepRenderer from "@/components/estimate/StepRenderer"
import RequestScreen from "@/components/estimate/ResultScreen"
          ...
          <div className="rounded-2xl bg-brand-yellow p-14">
            {isResult ? (
              <>
                ...
                <RequestScreen answers={answers} onReset={handleReset} />
              </>
            ) : (
              step && (
                <>
